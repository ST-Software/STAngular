...
//Based on example taken from http://odetocode.com/blogs/scott/archive/2013/07/10/angularjs-drag-and-drop-photo-directive.aspx
// and http://webreflection.blogspot.cz/2010/12/100-client-side-image-resizing.html

module STAngular {
    Module.factory("sgImageResampler", [<any>"$window", "$q", function ($window: ng.IWindowService, $q: ng.IQService) {
